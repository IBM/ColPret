...
def more_size_is_predictive(df, force=False, fig_dir=None, show=False, loss_types=("perp"), at_least_loss=float("inf"),
                          num_train_models=4, abs_mnd=True):
    raise NotImplementedError


def closer_in_scale_is_predictive(df, force=False, fig_dir=None, show=False, loss_types=("perp"), at_least_loss=float("inf"),
                          num_train_models=4, abs_mnd=True):
    cut_beginning = 10 ** 10
...
if __name__ == '__main__':
    ...
    raise NotImplementedError
    more_size_is_predictive(df, force=force, fig_dir=fig_dir, at_least_loss=10, abs_mnd=abs_mnd)
